	...
	<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<a class="btn btn-primary btn-sm bg-gradient-teal rounded-0" href="./?page=bookings/manage_booking&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Editar</a>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=bookings"><i class="fa fa-angle-left"></i>Volver</a>
			</div>
		</div>
	</div>
</div>
