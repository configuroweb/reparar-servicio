	...
	<div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			<div class="card-header py-0">
				<div class="card-title py-1"><b><?= isset($id) ? "Actualizar Reserva" : "Nueva Reserva" ?></b></div>
			</div>
			<div class="card-body">
				<div class="container-fluid mt-3">
					<form action="" id="booking-form">
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="contact" class="control-label"># Móvil</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-teal btn-flat border-0" form="booking-form"><i class="fa fa-save"></i> Guardar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=bookings"><i class="fa fa-times"></i> Cancelar</a>
			</div>
		</div>
	</div>
</div>
