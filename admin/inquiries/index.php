						...
						?>
							<tr>
								...
								<td class="align-items-center text-center">
									<?php if ($row['status'] == 1) : ?>
										<span class="badge bg-success px-3 rounded-pill">Leida</span>
									<?php else : ?>
										<span class="badge bg-secondary px-3 rounded-pill">Por leer</span>
									<?php endif; ?>
								</td>
								<td class="align-items-center" align="center">
									<div class="dropdown">
										...
										<div class="dropdown-menu" role="menu">
											<a class="dropdown-item" href="./?page=inquiries/view_inquiry&id=<?php echo $row['id'] ?>"><span class="bi bi-card-text text-dark"></span>Ver</a>
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("Deseas eliminar esta consulta permanentemente?", "delete_inquiry", [$(this).attr('data-id')])
		})
