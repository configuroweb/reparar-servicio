	...
	<div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			<div class="card-header py-0">
				<div class="card-title py-1"><b><?= isset($id) ? "Actualizar Información de Servicio" : "Información del Servicio" ?></b></div>
			</div>
			<div class="card-body">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-teal btn-flat border-0" form="service-form"><i class="fa fa-save"></i>Guardar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=services"><i class="fa fa-times"></i>Cancelar</a>
			</div>
		</div>
	</div>
</div>
