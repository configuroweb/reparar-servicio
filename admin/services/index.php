...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header ">
		<div class="card-tools d-flex justify-content-end">
			<a href="<?= base_url ?>admin?page=services/manage_service" id="create_new" class="btn btn-flat btn-primary bg-gradient-teal border-0 rounded00"><span class="fas fa-plus"></span> Crear Servicio</a>
		</div>
	</div>
	<div class="card-body">
						...
						?>
							<tr>
								...
								<td class="align-items-center justify-content-center text-center">
									<?php if ($row['status'] == 1) : ?>
										<span class="badge bg-success px-3 rounded-pill">Activo</span>
									<?php else : ?>
										<span class="badge bg-danger px-3 rounded-pill">Inactivo</span>
									<?php endif; ?>
								</td>
								<td class="align-items-center" align="center">
									<div class="dropdown">
										...
										<div class="dropdown-menu" role="menu">
											<a class="dropdown-item" href="./?page=services/view_service&id=<?php echo $row['id'] ?>"><span class="bi bi-card-text text-dark"></span> Ver</a>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item" href="./?page=services/manage_service&id=<?php echo $row['id'] ?>"><span class="bi bi-pencil-square text-primary"></span> Editar</a>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="bi bi-trash text-danger"></span> Eliminar</a>
										</div>
									</div>
								</td>
							</tr>
