...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
			...
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<div class="custom-file">
						<input type="file" class="form-control" id="customFile1" name="img">
				...
				<div class="form-group">
					<label for="" class="control-label">Carátula del Sitio</label>
					<div class="custom-file">
				...
				<div class="form-group">
					...
					<small><i>Escoge una imagen para subir a la galería</i></small>
				</div>
				<?php
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary bg-gradient-teal border-0" form="system-frm">Actualizar</button>
				</div>
			</div>
		</div>
...
<script>
	...
	function delete_img($path) {
		...
		$.ajax({
			...
			error: err => {
				console.log(err)
				alert_toast("Ocurrió un error eliminando imagen", "error");
				end_loader()
			},
	...
	$(document).ready(function() {
		$('.rem_img').click(function() {
			_conf("Deseas eliminar esta imagen permanentemente?", 'delete_img', ["'" + $(this).attr('data-path') + "'"])
		})
