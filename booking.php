<h1 class="pageTitle text-center">Haz tu Reserva</h1>
<hr class="mx-auto bg-primary border-primary opacity-100" style="width:50px">
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 col-12">
        <div class="card">
            <div class="card-body py-4">
                <h4 class="pageTitle">Diligencia todos los campos requeridos</h4>
                <form action="" id="book-form">
                    ...
                    <div class="mb-3">
                        <label for="contact" class="form-label">N° Móvil</label>
            ...
            <div class="card-footer">
                <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto">
                    <button class="btn btn-primary btn-sm w-100" form="book-form"><i class="bi bi-send"></i> Reservar ahora</button>
                </div>
            </div>
        </div>
    </div>
